...
#    May 27, 2022 06:05:26 PM +0700  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.top = top
        self.checkDoimatkhau = tk.IntVar()
        self.checkThememailkhoiphuc = tk.IntVar()
        self.checkAutoVerify = tk.IntVar()
        ...
        self.btnImport.configure(text='''Nhập''')
        ...
        self.btnRun.place(relx=0.239, rely=0.881, height=34, width=107)
        ...
        self.btnRun.configure(text='''Chạy''')

        self.btnXuat = customtkinter.CTkButton(self.TNotebook1_t1)
        self.btnXuat.place(relx=0.463, rely=0.881, height=34, width=107)



        self.btnXuat.configure(compound='left')




        self.btnXuat.configure(pady="0")
        self.btnXuat.configure(text='''Xuất''')

        self.txtSoLuong = customtkinter.CTkEntry(self.TNotebook1_t2)
        self.txtSoLuong.place(relx=0.125, rely=0.093, height=21, relwidth=0.093)
        ...
        self.check1.place(relx=0.025, rely=0.163, relheight=0.058, relwidth=0.14)
        ...
        self.check1.configure(text='''Đổi mật khẩu''')
        self.check1.configure(variable=self.checkDoimatkhau)

        self.Message1 = tk.Message(self.TNotebook1_t2)
        self.Message1.place(relx=0.025, rely=0.093, relheight=0.044
                , relwidth=0.088)
        ...
        self.check1_1.place(relx=0.025, rely=0.21, relheight=0.058
                , relwidth=0.19)
        ...
        self.check1_1.configure(text='''Thêm email khôi phục''')
        self.check1_1.configure(variable=self.checkThememailkhoiphuc)

        self.check1_1_1 = tk.Checkbutton(self.TNotebook1_t2)
        self.check1_1_1.place(relx=0.025, rely=0.256, relheight=0.058
                , relwidth=0.19)


        self.check1_1_1.configure(anchor='w')

        self.check1_1_1.configure(compound='left')




        self.check1_1_1.configure(justify='left')
        self.check1_1_1.configure(text='''Verify phone''')
        self.check1_1_1.configure(variable=self.checkAutoVerify)
